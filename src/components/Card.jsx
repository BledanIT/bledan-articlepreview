...
const Card = () => {
  return (
    ...
    lg:grid-flow-col lg:grid-cols-[1fr_2fr] lg:grid-rows-[auto_auto] lg:w-[72rem]'>
        <img src='../public/images/drawers.jpg' alt='drawers' className='object-cover object-top rounded-t-xl w-full h-80
